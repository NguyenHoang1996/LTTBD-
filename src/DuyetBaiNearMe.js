    ...
    render() {
        let test = this.state.aaaa.map(item => {
            ...
            if (item.text.length < 15)
                tenDiaDiem = <Text style={{ fontSize: 14, fontWeight: "bold", color: "black" }}>{item.text}</Text>
            else
                tenDiaDiem = <Text style={{ fontSize: 14, fontWeight: "bold", color: "black" }}>{item.text.slice(0, 13) + "..."}</Text>


            if (item.diaChi.length < 18)
                tenDiaChi = <Text style={{ fontSize: 12 }}>{item.diaChi}</Text>
            else
                tenDiaChi = <Text style={{ fontSize: 12 }}>{item.diaChi.slice(0, 17) + "..."}</Text>
